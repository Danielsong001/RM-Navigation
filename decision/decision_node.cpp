...
class DecisionNode{
 public:
  DecisionNode():global_planner_actionlib_client_("global_planner_node_action", true),
			...
			yolo_actionlib_client_
("yolo_node_action", true),
 ...
 //   yolo_actionlib_client_.waitForServer();
 //   std::cout<<"Yolo module has been connected!"<<std::endl;
   // yolo_goal_.command = 1;
    //olo_actionlib_client_.sendGoal(yolo_goal_);   
...
//    armor_detection_actionlib_client_.sendGoal(armor_detection_goal_);
 ...
 private:
  ...
  actionlib::SimpleActionClient<messages::InfantryInfoAction> yolo_actionlib_client_;  actionlib::SimpleActionClient<messages::ArmorDetectionAction> armor_detection_actionlib_client_;
  ...
  messages::InfantryInfoGoal yolo_goal_;
